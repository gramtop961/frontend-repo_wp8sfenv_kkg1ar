...
export default function Testimonials() {
  return (
    <section className="relative bg-[#120a06] py-20 text-white">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute left-8 top-10 h-56 w-56 rounded-full bg-amber-500/10 blur-3xl" />
        <div className="absolute bottom-10 right-8 h-56 w-56 rounded-full bg-orange-600/10 blur-3xl" />
      </div>

      <div className="relative mx-auto max-w-6xl px-6">
        <div className="mx-auto mb-10 max-w-2xl text-center">
          <h2 className="text-3xl font-semibold sm:text-4xl">Real couples, real stories</h2>
          <p className="mt-3 text-amber-100/85">Gentle inspiration from people building love, one day at a time.</p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {stories.map((s, i) => (
            ...
            >
              ...
              <p className="mt-4 text-amber-100/90">“{s.quote}”</p>
              <footer className="mt-6 text-sm text-amber-200">
